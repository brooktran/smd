...
<div class="div_head">
            <span>
                <span style="float:left">当前位置是：商品管理-》创建分类</span>
...
<div style="font-size: 13px;margin: 10px 5px">
    ...
    <table border="0" width="100%" class="table_a">
        <tr>
            ...
            <td width=300>
                <?php echo $form -> textField($model,'name',array('size'=>10,'maxlength'=>20,'class'=>'abc')); ?>
            </td>
        ...
        <tr>
            ...
            <td>
                <?php echo $form -> textArea($model,'introduce',array('cols'=>30,'rows'=>5)); ?>
            </td>

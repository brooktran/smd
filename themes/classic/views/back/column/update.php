    ...
    <div class="col-lg-12">
        <div class="box">
            <header class="dark">
                ...
                <h5>修改<?php echo $_GET['tid']==Yii::app()->params['ATTR_ARTICLE_TYPEID'] ? "文章" : "产品"?>分类</h5>
                <div class="toolbar">
                    <ul class="nav">
                        <li>
                            <div class="btn-group">
            ...
            <div id="collapse2" class="body collapse in">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4">
                            <?php echo $form->dropDownList($model,'fdParentID',array(CHtml::listData($cates,'id','fdName')),
                                array(
                                    'options'=>array($cate->fdParentID=>array('selected'=>true)),
                                    'empty'=>'请选择',
                                    'id'=>'sport',
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <?php echo $form->textField($model,'name',array('value'=>$cate->fdName,'class'=>'validate[required] form-control')); ?>
                    ...
                    <div class="col-lg-12">
                        <div class="box">
                            ...
                            <div id="cleditorDiv" class="body collapse in">
                                <?php echo $form->textArea($model,'introduce',array('value'=>$cate->fdDescription,'class'=>'form-control','id'=>"cleditor",'cols'=>30,'rows'=>5)); ?>
